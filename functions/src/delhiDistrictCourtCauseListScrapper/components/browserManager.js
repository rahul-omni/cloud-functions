 ...
 */
const navigateToPage = async (page, court) => {
  await page.goto(`https://${court}.dcourts.gov.in/cause-list-%E2%81%84-daily-board/#`, {
    waitUntil: 'networkidle0',
    timeout: 60000
  });
  console.log('[info] [browserManager] Successfully navigated to cause list page');
