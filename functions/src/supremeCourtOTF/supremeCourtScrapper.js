...
// // Env or config (optional chaining so module loads when environment is missing, e.g. new project)
// const openAiKey = process.env.OPENAI_API_KEY || functions.config().environment?.openai_api_key;
// const KEY = openAiKey;
// if (!KEY) { console.error('🔴  OPENAI_API_KEY missing (set OPENAI_API_KEY env or config when using this scraper)'); }
