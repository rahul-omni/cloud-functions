 ...
 */
const createPage = async (browser, url = "https://highcourtchd.gov.in/?mod=causelist") => {
...
const navigateToPage = async (page) => {
  const url = 'https://highcourtchd.gov.in/?mod=causelist';
  await page.goto(url, {
  ...
  await page.waitForSelector('#datepicker', { visible: true, timeout: 120000 }); // 2 minutes timeout
